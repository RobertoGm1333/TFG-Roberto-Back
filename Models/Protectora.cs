...
public class Protectora {
    ...
    public Protectora(string nombre_Protectora, string direccion, string telefono_Protectora, string correo_Protectora, string pagina_Web, string imagen_Protectora, string ubicacion, string descripcion_Protectora, int id_Usuario) {
